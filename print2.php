	...
	<div class="page_wrapper">
		<header>
			...
			<div class="header_title">
				...
				<div class="property_image">
					<?php // this displays the property's image
						$property_selected=$_SESSION["message"];
						$q = "SELECT ID, name, address, image FROM property WHERE ID = $property_selected";
								//assign items in array into variables
						list($propertyID,$propertyName,$address,$image) = mysqli_fetch_array($r);
							echo $image; // <img src="images/addams-home.jpg" alt="Addams Family House"> // how to format this??
						 ?>					
		...
		<div class="content">
			...
			<div class="print_headings">
				<p class="heading1"><?php echo $propertyName; ?></p>
				<p class="heading2"><?php echo $address; ?></p>
				<hr class="border">
			...
			<div class="print_data">
				<div class="print_categories">
					<table class="inventory_by_property" >
						...
						<?php 
							include "inc/inventory_by_room_process.inc.php";
